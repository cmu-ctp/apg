...
class ActionEntry {
    ...
    x: number;
    y: number;
	constructor(label: string, tooltip: string, pic:string, x:number, y:number ) {
		this.label = label;
...
class ButtonCollection {
	...
	constructor(w:Phaser.Group, apg:APGSys, size: number, setToolTip: (str: string) => void, setOption: (val: number) => void, buttonsInit: ActionEntry[]) {
