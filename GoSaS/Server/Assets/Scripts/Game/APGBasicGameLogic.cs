...
namespace APG {
	...
	public class APGBasicGameLogic:MonoBehaviour {
        ...
        public void SetFields( AudiencePhaseStatus theAStatus, Transform theStransform,Backgrounds theBackgrounds){
            aStatus = theAStatus;
		...
		void Start() {
            ...
            fullGame = new FullGame(this, network);
        ...
        void AtStartActionEnd() {
            ...
            AudiencePhase.MakeRoundEnd(aStatus, roundNumber, buddies.GetPlayerGrid(), () => pauseEnded = true, stransform, backgrounds);}
